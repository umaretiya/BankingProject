...
DataIngestionConfig = namedtuple("DataIngestionConfig", ["dataset_download_url", "tgz_download_dir", "tgz_file_name", "raw_data_dir", "ingested_train_dir", "ingested_test_dir"])

...
from project.entity.artifact_entity import (
    ModelEvaluationArtifact,ModelPusherArtifact,ModelTrainerArtifact,DataIngestionArtifact,DataTransformationArtifact,DataValidationArtifact)
...
from project.constant import EXPERIMENT_DIR_NAME,EXPERIMENT_FILE_NAME
...
Experiment = namedtuple("Experiment", ["experiment_id","initialization_timestamp","artifact_time_stamp",
                                       ...
                                       "experiment_filepath", "message","accuracy","is_model_accepted"])
...
class Pipeline(Thread):
    ...
    def run_pipeline(self):
        try:
            ...
            Pipeline.experiment = Experiment(
                ...
                stop_time=None,
                execution_time=None,
                experiment_filepath=Pipeline.experiment_file_path,
            ...
            if model_evaluation_artifact.is_model_accepted:
                ...
                logging.info(f"Model pusher: {model_pusher_artifact}")
            else:
    ...
    @classmethod    
    def get_experiments_status(cls, limit:int = 5):
        try:
            if os.path.exists(Pipeline.experiment_file_path):
